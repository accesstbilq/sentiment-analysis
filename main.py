...
rf_vectorizer = joblib.load('tfidf_vectorizer.joblib')
rf_model = joblib.load('random_forest_model.joblib')
lr_vectorizer = joblib.load('tfidf_vectorizer.joblib')
...
#             text_vectorized = rf_vectorizer.transform([processed_text])
#             prediction = rf_model.predict(text_vectorized)[0]
#         else:
#             text_vectorized = lr_vectorizer.transform([processed_text])
...
def predict():
    ...
    if request.method == 'POST':
        ...
        processed_text = preprocess_text(input_text, contractions)
